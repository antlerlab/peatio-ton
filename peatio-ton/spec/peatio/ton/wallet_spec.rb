...
RSpec.describe Peatio::Ton::Wallet do
  let(:wallet) { Peatio::Ton::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Ton::Wallet.new }
    ...
    it "sets settings attribute" do
      ...
      expect(unconfigured_wallet.settings)
        .to eq(settings.slice(*Peatio::Ton::Wallet::SUPPORTED_SETTINGS))
    end
  end
